...
namespace org.kbinani.vsq {
    ...
    public class SymbolTable : ICloneable {
        ...
        /// 辞書本体
        /// </summary>
        private Dictionary<String, SymbolTableEntry> m_dict;
        /// <summary>
        /// 辞書の名前
        /// </summary>
        ...
        #region static field
        /// <summary>
        /// 辞書のリスト（Dictionaryのkeyは、辞書の優先順位）
        /// </summary>
        private static Dictionary<Integer, SymbolTable> s_table = new Dictionary<Integer, SymbolTable>();
        /// <summary>
...
#endif
            Dictionary<Integer, SymbolTable> buff = new Dictionary<Integer, SymbolTable>();
            for ( Iterator<Integer> itr = s_table.keySet().iterator(); itr.hasNext(); ) {
                int key = itr.next();
        ...
        public Object clone() {
            ...
            ret.m_dict = new Dictionary<String, SymbolTableEntry>();
        ...
        public SymbolTable( String path, boolean is_udc_mode, boolean enabled, String encoding ) {
            m_dict = new Dictionary<String, SymbolTableEntry>();
            m_enabled = enabled;
