...
namespace org.kbinani.vsq {
    ...
    public class VsqMetaText : ICloneable {
        ...
        /* public VsqMetaText( TextMemoryStream sr ) {
            ...
            Dictionary<Integer, VsqID> __id = new Dictionary<Integer, VsqID>();
            Dictionary<Integer, VsqHandle> __handle = new Dictionary<Integer, VsqHandle>();
            PIT = new VsqBPList( "pit", 0, -8192, 8191 );
            PBS = new VsqBPList( "pbs", 2, 0, 24 );
            DYN = new VsqBPList( "dyn", 64, 0, 127 );
            BRE = new VsqBPList( "bre", 0, 0, 127 );
