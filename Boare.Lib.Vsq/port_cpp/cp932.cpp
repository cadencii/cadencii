...
static bool cp932_initialized = false;
const int _LEN_DICT = 9484;
...
void cp932_init() {
    ...
    cp932_initialized = true;
}

vector<unsigned char> cp932_convert( wstring str ){
    int len = str.size();
...
wstring cp932_convert( vector<unsigned char> dat ){
    if ( !cp932_initialized ) {
        cp932_init();
    }
    wostringstream sb;
    int i = 0;
