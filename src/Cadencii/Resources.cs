...
//makeRes -i D:\GitHub\kbinani\cadencii\src\Cadencii\Resources.list -o D:\GitHub\kbinani\cadencii\src\Cadencii\Resources.cs -p cadencii -n cadencii
#if JAVA
package cadencii;
...
namespace cadencii{
    ...
    public class Resources{
        ...
        private static String getBasePath(){
            if( basePath == null ){
                basePath = Path.Combine( PortUtil.getApplicationStartupPath(), "resources" );
            }
            return basePath;
        }
        ...
        public static Image get_alarm_clock(){
            if( s_alarm_clock == null ){
                String res_path = Path.Combine( getBasePath(), "alarm-clock.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_090(){
            if( s_arrow_090 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow-090.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_180(){
            if( s_arrow_180 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow-180.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_270(){
            if( s_arrow_270 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow-270.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_skip_090(){
            if( s_arrow_skip_090 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow-skip-090.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_135(){
            if( s_arrow_135 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow_135.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_circle_double(){
            if( s_arrow_circle_double == null ){
                String res_path = Path.Combine( getBasePath(), "arrow_circle_double.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_return(){
            if( s_arrow_return == null ){
                String res_path = Path.Combine( getBasePath(), "arrow_return.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_skip(){
            if( s_arrow_skip == null ){
                String res_path = Path.Combine( getBasePath(), "arrow_skip.png" );
                try{
#if JAVA
        ...
        public static Image get_arrow_skip_180(){
            if( s_arrow_skip_180 == null ){
                String res_path = Path.Combine( getBasePath(), "arrow_skip_180.png" );
                try{
#if JAVA
        ...
        public static Image get_btn1(){
            if( s_btn1 == null ){
                String res_path = Path.Combine( getBasePath(), "btn1.png" );
                try{
#if JAVA
        ...
        public static Image get_btn2(){
            if( s_btn2 == null ){
                String res_path = Path.Combine( getBasePath(), "btn2.png" );
                try{
#if JAVA
        ...
        public static Image get_btn3(){
            if( s_btn3 == null ){
                String res_path = Path.Combine( getBasePath(), "btn3.png" );
                try{
#if JAVA
        ...
        public static Image get_chevron_small_collapse(){
            if( s_chevron_small_collapse == null ){
                String res_path = Path.Combine( getBasePath(), "chevron-small-collapse.png" );
                try{
#if JAVA
        ...
        public static Image get_clipboard_paste(){
            if( s_clipboard_paste == null ){
                String res_path = Path.Combine( getBasePath(), "clipboard_paste.png" );
                try{
#if JAVA
        ...
        public static Image get_control(){
            if( s_control == null ){
                String res_path = Path.Combine( getBasePath(), "control.png" );
                try{
#if JAVA
        ...
        public static Image get_control_double(){
            if( s_control_double == null ){
                String res_path = Path.Combine( getBasePath(), "control_double.png" );
                try{
#if JAVA
        ...
        public static Image get_control_double_180(){
            if( s_control_double_180 == null ){
                String res_path = Path.Combine( getBasePath(), "control_double_180.png" );
                try{
#if JAVA
        ...
        public static Image get_control_pause(){
            if( s_control_pause == null ){
                String res_path = Path.Combine( getBasePath(), "control_pause.png" );
                try{
#if JAVA
        ...
        public static Image get_control_skip(){
            if( s_control_skip == null ){
                String res_path = Path.Combine( getBasePath(), "control_skip.png" );
                try{
#if JAVA
        ...
        public static Image get_control_stop(){
            if( s_control_stop == null ){
                String res_path = Path.Combine( getBasePath(), "control_stop.png" );
                try{
#if JAVA
        ...
        public static Image get_control_stop_180(){
            if( s_control_stop_180 == null ){
                String res_path = Path.Combine( getBasePath(), "control_stop_180.png" );
                try{
#if JAVA
        ...
        public static Image get_cross_small(){
            if( s_cross_small == null ){
                String res_path = Path.Combine( getBasePath(), "cross-small.png" );
                try{
#if JAVA
        ...
        public static Image get_disk(){
            if( s_disk == null ){
                String res_path = Path.Combine( getBasePath(), "disk.png" );
                try{
#if JAVA
        ...
        public static Image get_disk__plus(){
            if( s_disk__plus == null ){
                String res_path = Path.Combine( getBasePath(), "disk__plus.png" );
                try{
#if JAVA
        ...
        public static Image get_documents(){
            if( s_documents == null ){
                String res_path = Path.Combine( getBasePath(), "documents.png" );
                try{
#if JAVA
        ...
        public static Image get_drive(){
            if( s_drive == null ){
                String res_path = Path.Combine( getBasePath(), "drive.png" );
                try{
#if JAVA
        ...
        public static Image get_edit_list_order(){
            if( s_edit_list_order == null ){
                String res_path = Path.Combine( getBasePath(), "edit-list-order.png" );
                try{
#if JAVA
        ...
        public static Image get_end_marker(){
            if( s_end_marker == null ){
                String res_path = Path.Combine( getBasePath(), "end_marker.png" );
                try{
#if JAVA
        ...
        public static Image get_eraser(){
            if( s_eraser == null ){
                String res_path = Path.Combine( getBasePath(), "eraser.png" );
                try{
#if JAVA
        ...
        public static Image get_folder__plus(){
            if( s_folder__plus == null ){
                String res_path = Path.Combine( getBasePath(), "folder--plus.png" );
                try{
#if JAVA
        ...
        public static Image get_folder(){
            if( s_folder == null ){
                String res_path = Path.Combine( getBasePath(), "folder.png" );
                try{
#if JAVA
        ...
        public static Image get_folder_horizontal_open(){
            if( s_folder_horizontal_open == null ){
                String res_path = Path.Combine( getBasePath(), "folder_horizontal_open.png" );
                try{
#if JAVA
        ...
        public static Image get_layer_shape_curve(){
            if( s_layer_shape_curve == null ){
                String res_path = Path.Combine( getBasePath(), "layer_shape_curve.png" );
                try{
#if JAVA
        ...
        public static Image get_layer_shape_line(){
            if( s_layer_shape_line == null ){
                String res_path = Path.Combine( getBasePath(), "layer_shape_line.png" );
                try{
#if JAVA
        ...
        public static Image get_pencil(){
            if( s_pencil == null ){
                String res_path = Path.Combine( getBasePath(), "pencil.png" );
                try{
#if JAVA
        ...
        public static Image get_piano(){
            if( s_piano == null ){
                String res_path = Path.Combine( getBasePath(), "piano.png" );
                try{
#if JAVA
        ...
        public static Image get_pin__arrow(){
            if( s_pin__arrow == null ){
                String res_path = Path.Combine( getBasePath(), "pin__arrow.png" );
                try{
#if JAVA
        ...
        public static Image get_pin__arrow_inv(){
            if( s_pin__arrow_inv == null ){
                String res_path = Path.Combine( getBasePath(), "pin__arrow_inv.png" );
                try{
#if JAVA
        ...
        public static Image get_ruler_crop(){
            if( s_ruler_crop == null ){
                String res_path = Path.Combine( getBasePath(), "ruler_crop.png" );
                try{
#if JAVA
        ...
        public static Image get_scissors(){
            if( s_scissors == null ){
                String res_path = Path.Combine( getBasePath(), "scissors.png" );
                try{
#if JAVA
        ...
        public static Image get_slash(){
            if( s_slash == null ){
                String res_path = Path.Combine( getBasePath(), "slash.png" );
                try{
#if JAVA
        ...
        public static Image get_start_marker(){
            if( s_start_marker == null ){
                String res_path = Path.Combine( getBasePath(), "start_marker.png" );
                try{
#if JAVA
        ...
        public static Image get_target__pencil(){
            if( s_target__pencil == null ){
                String res_path = Path.Combine( getBasePath(), "target--pencil.png" );
                try{
#if JAVA
        ...
        public static Image get_VSTonWht(){
            if( s_VSTonWht == null ){
                String res_path = Path.Combine( getBasePath(), "VSTonWht.png" );
                try{
#if JAVA
...
#endif
            if( s_icon == null ){
                String res_path = Path.Combine( getBasePath(), "icon.ico" );
                try{
#if JAVA
...
#endif
            if( s_switch == null ){
                String res_path = Path.Combine( getBasePath(), "switch.ico" );
                try{
#if JAVA
        ...
        public static Image get_cresc1(){
            if( s_cresc1 == null ){
                String res_path = Path.Combine( getBasePath(), "cresc1.png" );
                try{
#if JAVA
        ...
        public static Image get_cresc2(){
            if( s_cresc2 == null ){
                String res_path = Path.Combine( getBasePath(), "cresc2.png" );
                try{
#if JAVA
        ...
        public static Image get_cresc3(){
            if( s_cresc3 == null ){
                String res_path = Path.Combine( getBasePath(), "cresc3.png" );
                try{
#if JAVA
        ...
        public static Image get_cresc4(){
            if( s_cresc4 == null ){
                String res_path = Path.Combine( getBasePath(), "cresc4.png" );
                try{
#if JAVA
        ...
        public static Image get_cresc5(){
            if( s_cresc5 == null ){
                String res_path = Path.Combine( getBasePath(), "cresc5.png" );
                try{
#if JAVA
        ...
        public static Image get_dim1(){
            if( s_dim1 == null ){
                String res_path = Path.Combine( getBasePath(), "dim1.png" );
                try{
#if JAVA
        ...
        public static Image get_dim2(){
            if( s_dim2 == null ){
                String res_path = Path.Combine( getBasePath(), "dim2.png" );
                try{
#if JAVA
        ...
        public static Image get_dim3(){
            if( s_dim3 == null ){
                String res_path = Path.Combine( getBasePath(), "dim3.png" );
                try{
#if JAVA
        ...
        public static Image get_dim4(){
            if( s_dim4 == null ){
                String res_path = Path.Combine( getBasePath(), "dim4.png" );
                try{
#if JAVA
        ...
        public static Image get_dim5(){
            if( s_dim5 == null ){
                String res_path = Path.Combine( getBasePath(), "dim5.png" );
                try{
#if JAVA
        ...
        public static Image get_splash(){
            if( s_splash == null ){
                String res_path = Path.Combine( getBasePath(), "splash.png" );
                try{
#if JAVA
        ...
        public static Image get_plus8x8(){
            if( s_plus8x8 == null ){
                String res_path = Path.Combine( getBasePath(), "plus8x8.png" );
                try{
#if JAVA
        ...
        public static Image get_minus8x8(){
            if( s_minus8x8 == null ){
                String res_path = Path.Combine( getBasePath(), "minus8x8.png" );
                try{
#if JAVA
