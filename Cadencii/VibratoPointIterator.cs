...
namespace org.kbinani.cadencii {
    ...
    /// </summary>
#if JAVA
    public class VibratoPointIterator2 implements Iterator<Double> {
#else
    public class VibratoPointIterator2 : Iterator<Double> {
#endif
        VsqFileEx vsq;
        VibratoBPList rate;
        int start_rate;
        ...
        public VibratoPointIterator2( VsqFileEx vsq,
                                      VibratoBPList rate,
                                      int start_rate,
                                      VibratoBPList depth,
                                      int start_depth,
