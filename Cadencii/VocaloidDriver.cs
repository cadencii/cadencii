...
namespace org.kbinani.cadencii.new_ {
    ...
    public unsafe class VocaloidDriver : vstidrv {
        ...
        Vector<MidiEvent> s_track_events;
        ...
        int dseVersion;
        TempoVector tempoTable = new TempoVector();

        public void setTempoTable( TempoVector tempo_table ) {
            tempoTable = tempo_table;
        }
        ...
        public override boolean open( string dll_path, int block_size, int sample_rate, boolean use_native_dll_loader ) {
            ...
            g_progress = 0.0;
            s_track_events = new Vector<MidiEvent>();
            return ret;
        }
        ...
        public int StartRendering( long total_samples, boolean mode_infinite, int sample_rate, VocaloidRenderingRunner runner ) {
            ...
            Vector<MidiEvent> lpEvents = s_track_events;//            merge_events( s_track_events.get( 0 ), s_track_events.get( 1 ) );
            int current_count = -1;
            ...
            try {
                ...
                while ( true ) {
                    ...
                    double msNow = tempoTable.getSecFromClock( dwNow ) * 1000.0;//                    msec_from_clock( dwNow );
                ...
                double msLast = tempoTable.getSecFromClock( dwNow ) * 1000.0;//                msec_from_clock( dwNow );
