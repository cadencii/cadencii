...
#else
    public class StraightRenderingRunner_OBSOLUTE : RenderingRunner_OBSOLUTE {
#endif
        ...
        public StraightRenderingRunner_OBSOLUTE( VsqFileEx vsq,
                                        int track,
                ...
                if ( m_reflect_amp_to_wave ) {
                    ...
                    if ( m_wave_writer != null ) {
                        try {
                            ...
                            PortUtil.println( "StraightRenderingRunner#WaveIncoming; ex=" + ex );
                        }
                    }
                } else {
                    if ( m_wave_writer != null ) {
