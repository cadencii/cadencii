...
namespace cadencii
{
    ...
    partial class Preference
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblAutoVibratoType = new cadencii.windows.forms.BLabel();
            this.radioVocaloidEditorCompatible = new cadencii.windows.forms.BRadioButton();
            this.groupUserDefined = new cadencii.windows.forms.BGroupBox();
            this.comboAutoVibratoTypeCustom = new cadencii.windows.forms.BComboBox();
            this.lblAutoVibratoTypeCustom = new cadencii.windows.forms.BLabel();
            this.label6 = new cadencii.windows.forms.BLabel();
            this.lblAutoVibratoThresholdLength = new cadencii.windows.forms.BLabel();
            this.label2 = new cadencii.windows.forms.BLabel();
            this.chkEnableAutoVibrato = new cadencii.windows.forms.BCheckBox();
            this.comboResolControlCurve = new cadencii.windows.forms.BComboBox();
            this.lblResolControlCurve = new cadencii.windows.forms.BLabel();
            this.label1 = new cadencii.windows.forms.BLabel();
            this.lblResolution = new cadencii.windows.forms.BLabel();
            this.label7 = new cadencii.windows.forms.BLabel();
            this.groupVocaloidEditorCompatible = new cadencii.windows.forms.BGroupBox();
            this.comboAutoVibratoType2 = new cadencii.windows.forms.BComboBox();
            this.lblAutoVibratoType2 = new cadencii.windows.forms.BLabel();
            this.comboAutoVibratoType1 = new cadencii.windows.forms.BComboBox();
            this.lblAutoVibratoType1 = new cadencii.windows.forms.BLabel();
            this.label3 = new cadencii.windows.forms.BLabel();
            this.comboVibratoLength = new cadencii.windows.forms.BComboBox();
            this.lblVibratoLength = new cadencii.windows.forms.BLabel();
            this.tabAnother = new System.Windows.Forms.TabPage();
            this.lblBufferSize = new cadencii.windows.forms.BLabel();
            this.lblBuffer = new cadencii.windows.forms.BLabel();
            this.label13 = new cadencii.windows.forms.BLabel();
            this.label12 = new cadencii.windows.forms.BLabel();
            this.comboDefualtSinger = new cadencii.windows.forms.BComboBox();
            this.chkChasePastEvent = new cadencii.windows.forms.BCheckBox();
            this.lblWait = new cadencii.windows.forms.BLabel();
            this.lblPreSendTime = new cadencii.windows.forms.BLabel();
            this.lblDefaultSinger = new cadencii.windows.forms.BLabel();
            ...
            this.groupFont = new cadencii.windows.forms.BGroupBox();
            this.labelMenu = new cadencii.windows.forms.BLabel();
            this.labelScreenFontName = new cadencii.windows.forms.BLabel();
            this.btnChangeScreenFont = new cadencii.windows.forms.BButton();
            this.labelScreen = new cadencii.windows.forms.BLabel();
            this.labelMenuFontName = new cadencii.windows.forms.BLabel();
            this.btnChangeMenuFont = new cadencii.windows.forms.BButton();
            this.groupVisibleCurve = new cadencii.windows.forms.BGroupBox();
            this.chkEnvelope = new cadencii.windows.forms.BCheckBox();
            this.chkPbs = new cadencii.windows.forms.BCheckBox();
            this.chkReso4 = new cadencii.windows.forms.BCheckBox();
            this.chkReso3 = new cadencii.windows.forms.BCheckBox();
            this.chkReso2 = new cadencii.windows.forms.BCheckBox();
            this.chkReso1 = new cadencii.windows.forms.BCheckBox();
            this.chkFx2Depth = new cadencii.windows.forms.BCheckBox();
            this.chkHarmonics = new cadencii.windows.forms.BCheckBox();
            this.chkPit = new cadencii.windows.forms.BCheckBox();
            this.chkPor = new cadencii.windows.forms.BCheckBox();
            this.chkGen = new cadencii.windows.forms.BCheckBox();
            this.chkOpe = new cadencii.windows.forms.BCheckBox();
            this.chkCle = new cadencii.windows.forms.BCheckBox();
            this.chkBri = new cadencii.windows.forms.BCheckBox();
            this.chkBre = new cadencii.windows.forms.BCheckBox();
            this.chkDyn = new cadencii.windows.forms.BCheckBox();
            this.chkVel = new cadencii.windows.forms.BCheckBox();
            this.chkVibratoDepth = new cadencii.windows.forms.BCheckBox();
            this.chkVibratoRate = new cadencii.windows.forms.BCheckBox();
            this.chkDecay = new cadencii.windows.forms.BCheckBox();
            this.chkAccent = new cadencii.windows.forms.BCheckBox();
            this.lblTrackHeight = new cadencii.windows.forms.BLabel();
            this.comboLanguage = new cadencii.windows.forms.BComboBox();
            this.lblLanguage = new cadencii.windows.forms.BLabel();
            this.numTrackHeight = new cadencii.NumericUpDownEx();
            this.tabOperation = new System.Windows.Forms.TabPage();
            this.groupMisc = new cadencii.windows.forms.BGroupBox();
            this.comboMtcMidiInPortNumber = new cadencii.windows.forms.BComboBox();
            this.labelMtcMidiInPort = new cadencii.windows.forms.BLabel();
            this.lblMaximumFrameRate = new cadencii.windows.forms.BLabel();
            this.comboMidiInPortNumber = new cadencii.windows.forms.BComboBox();
            this.numMaximumFrameRate = new cadencii.NumericUpDownEx();
            this.lblMidiInPort = new cadencii.windows.forms.BLabel();
            this.lblMouseHoverTime = new cadencii.windows.forms.BLabel();
            this.lblMilliSecond = new cadencii.windows.forms.BLabel();
            this.numMouseHoverTime = new cadencii.NumericUpDownEx();
            this.groupPianoroll = new cadencii.windows.forms.BGroupBox();
            this.chkTranslateRoman = new cadencii.windows.forms.BCheckBox();
            this.chkUseSpaceKeyAsMiddleButtonModifier = new cadencii.windows.forms.BCheckBox();
            this.labelWheelOrder = new cadencii.windows.forms.BLabel();
            this.numericUpDownEx1 = new cadencii.NumericUpDownEx();
            this.chkCursorFix = new cadencii.windows.forms.BCheckBox();
            this.chkCurveSelectingQuantized = new cadencii.windows.forms.BCheckBox();
            this.chkScrollHorizontal = new cadencii.windows.forms.BCheckBox();
            this.chkPlayPreviewWhenRightClick = new cadencii.windows.forms.BCheckBox();
            this.chkKeepLyricInputMode = new cadencii.windows.forms.BCheckBox();
            this.tabPlatform = new System.Windows.Forms.TabPage();
            this.groupWine = new cadencii.windows.forms.BGroupBox();
            ...
            this.labelWineTop = new cadencii.windows.forms.BLabel();
            this.buttonWineTop = new cadencii.windows.forms.BButton();
            this.textWineTop = new cadencii.windows.forms.BTextBox();
            this.labelWinePrefix = new cadencii.windows.forms.BLabel();
            this.buttonWinePrefix = new cadencii.windows.forms.BButton();
            this.textWinePrefix = new cadencii.windows.forms.BTextBox();
            this.groupUtauCores = new cadencii.windows.forms.BGroupBox();
            this.checkEnableWideCharacterWorkaround = new cadencii.windows.forms.BCheckBox();
            this.labelResamplerWithWine = new cadencii.windows.forms.BLabel();
            this.labelWavtoolPath = new cadencii.windows.forms.BLabel();
            this.buttonResamplerUp = new cadencii.windows.forms.BButton();
            this.buttonResamplerDown = new cadencii.windows.forms.BButton();
            this.buttonResamplerRemove = new cadencii.windows.forms.BButton();
            this.buttonResamplerAdd = new cadencii.windows.forms.BButton();
            this.listResampler = new cadencii.windows.forms.BListView();
            this.columnHeaderPath = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
            this.lblResampler = new cadencii.windows.forms.BLabel();
            this.chkWavtoolWithWine = new cadencii.windows.forms.BCheckBox();
            this.btnWavtool = new cadencii.windows.forms.BButton();
            this.lblWavtool = new cadencii.windows.forms.BLabel();
            this.txtWavtool = new cadencii.windows.forms.BTextBox();
            this.tabUtausingers = new System.Windows.Forms.TabPage();
            this.btnRemove = new cadencii.windows.forms.BButton();
            this.btnAdd = new cadencii.windows.forms.BButton();
            this.btnUp = new cadencii.windows.forms.BButton();
            this.btnDown = new cadencii.windows.forms.BButton();
            this.listSingers = new cadencii.windows.forms.BListView();
            this.tabFile = new System.Windows.Forms.TabPage();
            this.chkKeepProjectCache = new cadencii.windows.forms.BCheckBox();
            this.lblAutoBackupMinutes = new cadencii.windows.forms.BLabel();
            this.lblAutoBackupInterval = new cadencii.windows.forms.BLabel();
            this.chkAutoBackup = new cadencii.windows.forms.BCheckBox();
            this.numAutoBackupInterval = new cadencii.NumericUpDownEx();
            this.tabSingingSynth = new System.Windows.Forms.TabPage();
            this.groupDefaultSynthesizer = new cadencii.windows.forms.BGroupBox();
            this.comboDefaultSynthesizer = new cadencii.windows.forms.BComboBox();
            this.groupSynthesizerDll = new cadencii.windows.forms.BGroupBox();
            this.chkLoadAquesTone = new cadencii.windows.forms.BCheckBox();
            this.chkLoadVocaloid2 = new cadencii.windows.forms.BCheckBox();
            this.chkLoadVocaloid1 = new cadencii.windows.forms.BCheckBox();
            this.groupVsti = new cadencii.windows.forms.BGroupBox();
            ...
            this.btnAquesTone = new cadencii.windows.forms.BButton();
            this.txtAquesTone = new cadencii.windows.forms.BTextBox();
            this.lblAquesTone = new cadencii.windows.forms.BLabel();
            this.txtVOCALOID2 = new cadencii.windows.forms.BTextBox();
            this.txtVOCALOID1 = new cadencii.windows.forms.BTextBox();
            this.lblVOCALOID2 = new cadencii.windows.forms.BLabel();
            this.lblVOCALOID1 = new cadencii.windows.forms.BLabel();
