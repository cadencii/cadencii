    ...
    public class Resources {
...
#else
                    s_alarm_clock = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_090 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_180 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_270 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_skip_090 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_135 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_circle_double = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_return = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_skip = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_arrow_skip_180 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
        ...
        public static Image get_author_list() {
            if ( s_author_list == null ) {
                try {
                    String res_path = PortUtil.combinePath( getBasePath(), "author_list.png" );
#if JAVA
                    s_author_list = ImageIO.read( new File( res_path ) );
#else
                    s_author_list = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_chevron_small_collapse = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_clipboard_paste = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_double = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_double_180 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_pause = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_skip = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_stop = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_control_stop_180 = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_cross_small = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_disk__plus = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_documents = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_edit_list_order = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_end_marker = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_folder__plus = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_folder_horizontal_open = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_layer_shape_curve = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_layer_shape_line = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_pin__arrow = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_pin__arrow_inv = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_ruler_crop = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_scissors = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_start_marker = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_target__pencil = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
...
#else
                    s_VSTonWht = new Bitmap( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
        ...
        public static Icon get_icon() {
            if ( s_icon == null ) {
                try {
                    String res_path = PortUtil.combinePath( getBasePath(), "icon.ico" );
#if JAVA
                    Image img = ImageIO.read( new File( res_path ) );
                    s_icon = new ImageIcon( img );
#else
                    s_icon = new Icon( res_path );
#endif
                } catch ( Exception ex ) {
                }
            }
