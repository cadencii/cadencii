...
class XmlMember{
    ...
    public static XmlMember[] extractMembers( Class t ){
        ...
        for( String name : props ){
            ...
            if( isignored_getter != null ){
                try{
                    ignore = (Boolean)isignored_getter.invoke( null, name );
                }catch( Exception ex ){
                }
            }
            if( ignore ){
            ...
            String xmlname = name;
            if( elementname_getter != null ){
                try{
                    xmlname = (String)elementname_getter.invoke( null, name );
                }catch( Exception ex ){
                }
            }
    ...
    public Object get( Object obj ){
        try{
            ...
            System.out.println( "com.boare.util.XmlMember.get; ex=" + ex );
            return null;
        }
    }
    ...
    public void set( Object obj, Object value ){
        try{
            ...
            System.out.println( "com.boare.util.XmlMember.set; ex=" + ex );
        }
    }
}
