...
public class BDelegate{
    ...
    public BDelegate( Class invoker, String method_name, Class return_type, Class... argument_type ) throws Exception{
        m_invoker = null;
    ...
    public BDelegate( Object invoker, String method_name, Class return_type, Class... argument_type ) throws Exception{
