        ...
        using( StreamReader sr = new StreamReader( infile ) ){
            ...
            while( (line = sr.ReadLine()) != null ){
                ...
                if( type == "Image" ){
                    ...
                    sw.WriteLine( cs_space + "                PortUtil.stderr.println( \"Resources#get_" + name + "; ex=\" + ex + \"; res_path=\" + res_path );" );
                    sw.WriteLine( cs_space + "            }" );
                    sw.WriteLine( cs_space + "        }" );
                    ...
                    sw.WriteLine( cs_space + "                    PortUtil.stderr.println( \"Resources#get_" + name + "; ex0=\" + ex0 + \"; res_path=\" + res_path );" );
                    ...
                    sw.WriteLine( cs_space + "                            PortUtil.stderr.println( \"Resources#get_" + name + "; ex2=\" + ex2 + \"; res_path=\" + res_path );" );
                    sw.WriteLine( cs_space + "                        }" );
                    sw.WriteLine( cs_space + "                    }" );
                    sw.WriteLine( cs_space + "                }" );
                    sw.WriteLine( "#endif" );
