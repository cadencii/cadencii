...
clean:
	$(RM) $(TARGET)\org.kbinani.dll $(TARGET)\org.kbinani.apputil.dll $(TARGET)\org.kbinani.media.dll $(TARGET)\org.kbinani.vsq.dll $(TARGET)\Cadencii.exe $(TARGET)\PlaySound.dll
