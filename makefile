...
jcorlib: pp_cs2java.exe ./org.kbinani/*.cs
	mono ./pp_cs2java.exe $(PPCS2JAVA_OPT) -b ./build/java/ -t ./org.kbinani/
...
japputil: pp_cs2java.exe ./org.kbinani.apputil/*.cs
	mono ./pp_cs2java.exe $(PPCS2JAVA_OPT) -b ./build/java -t ./org.kbinani.apputil

./build/java/org/kbinani/apputil/Messaging.java: ./org.kbinani.apputil/Messaging.cs

jmedia: pp_cs2java.exe ./org.kbinani.media/*.cs
	mono ./pp_cs2java.exe $(PPCS2JAVA_OPT) -b ./build/java -t ./org.kbinani.media

jvsq: pp_cs2java.exe ./org.kbinani.vsq/*.cs
	mono ./pp_cs2java.exe $(PPCS2JAVA_OPT) -b ./build/java -t ./org.kbinani.vsq
